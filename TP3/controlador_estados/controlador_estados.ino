...
void loop() {
  ...
  u_act = K[0]*thita_medido + K[1]*dthita_medido + K[2]*phi_medido + K[3]*dphi_next;
  //u_act = K[0]*thita_next + K[1]*dthita_next + K[2]*phi_next + K[3]*dphi_next;
  
  //Aplico accion de control
  angle_2_servo(20 + u_act);
